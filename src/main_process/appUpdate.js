...
// 更新地址
const updateURL = 'https://files.zhiqiuge.com/software/install/';
...
function handleUpdate() {
	...
	if (process.env.NODE_ENV === 'development') {
		autoUpdater.updateConfigPath = path.join(process.cwd(), 'build/win-unpacked/resources/app-update.yml');
	} else {
